...
const DisplayEmployeeSkills = ({
    ...
    return (
        <>
            ...
            <Header as='h3' content='Click on ✔ to rate an employee skill' />
            <Table color='red'>
                <Table.Header>
            ...
            <Button as={Link} to='/employees' color='blue'>
...
export default DisplayEmployeeSkills;
