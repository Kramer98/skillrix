...
{
    const {emp_id,skill_name,experience,emp_rating,man_rating,skill_approval } = req.body
    console.log(emp_id)
    pool.query('insert into Employee_skills (emp_id,skill_name,experience,emp_rating,man_rating,skill_approval) values ($1,$2,$3,$4,$5,$6)',[emp_id,skill_name,experience,emp_rating,man_rating,skill_approval],(error,results) => {
        if(error)
        {
            throw error;
...
const getEmp = (req,res) => 
{
    ...
    console.log(emp_id)
    pool.query('select emp_name from Employee_details where manager_id = $1',[emp_id],(error,results) =>
    {
        if(error)
        {
            throw error;
